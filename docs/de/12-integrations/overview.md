...
HELBACKUP Widget für HELDASH Dashboard.
...
Zeigt: Status, letzte Backups, Erfolgsrate

### Home Assistant

Via Webhook oder REST API:
...
---
Weiter: [Home Assistant](home-assistant.md)
